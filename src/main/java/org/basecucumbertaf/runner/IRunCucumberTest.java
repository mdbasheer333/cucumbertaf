package org.basecucumbertaf.runner;
...
@CucumberOptions(
        plugin = {"pretty", "html:target/cucumber-reports/cucumber.html",
                ...
                "rerun:target/failedrerun.txt", "org.basecucumbertaf.testlib.ctaflisteners.ICTAFBDDTestListener"},
        features = {"src/test/resources"},
        glue = {"org.cucumbertaf.stepdefs", "org.cucumbertaf.hooks"})
public class IRunCucumberTest {
    ...
    public Object[][] scenarios(ITestContext context) {
        ...
        Integer iterCount;
        ExcelReader excelReader = new ExcelReader(IGlobals.data_exl_path, "features");
        ...
        if (allData.stream().noneMatch((mp)->mp.containsValue(fName.replaceAll(".feature", "")))) {
            ...
            excelReader = new ExcelReader(IGlobals.data_exl_path, fName.replaceAll(".feature", ""));
        ...
        if (iterations != 0) {
            IGlobals.counterTracker.get().put("total_scenarios_count", Integer.parseInt(String.valueOf(lst.size() / iterations)));
        }
        return custom_obj;
    }
