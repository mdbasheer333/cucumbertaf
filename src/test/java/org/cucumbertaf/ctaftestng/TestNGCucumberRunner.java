...
import static org.cucumbertaf.ctaftestng.TestCaseResultObserver.observe;
...
public final class TestNGCucumberRunner {
    ...
    public void runScenario(org.cucumbertaf.ctaftestng.Pickle pickle) {
            ...
            return features.stream()
                    .flatMap(feature -> feature.getPickles().stream()
                            ...
                            .map(cucumberPickle -> new Object[]{
                                    new PickleWrapperImpl(new org.cucumbertaf.ctaftestng.Pickle(cucumberPickle)),
